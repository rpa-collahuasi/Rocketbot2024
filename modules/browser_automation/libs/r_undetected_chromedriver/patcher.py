...
class Patcher(object):
    ...
    if platform.endswith("win32"):
        d = "~/appdata/roaming/r_undetected_chromedriver"
    elif "LAMBDA_TASK_ROOT" in os.environ:
        d = "/tmp/r_undetected_chromedriver"
    elif platform.startswith(("linux", "linux2")):
        d = "~/.local/share/r_undetected_chromedriver"
    elif platform.endswith("darwin"):
        d = "~/Library/Application Support/r_undetected_chromedriver"
    else:
        d = "~/.r_undetected_chromedriver"
